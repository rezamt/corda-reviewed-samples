...
class MainController(rpc: NodeRPCConnection) {
    ...
    fun createInvoice(request: HttpServletRequest): ResponseEntity<String> {
        ...
        // "Thu Jul 11 2019"
        val dateParam = request.getParameter("date").substringBefore("00").trim()
        // https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html
        //val date = LocalDate.parse(dateParam, DateTimeFormatter.ofPattern("E MMMM d yyyy"))
        val date = LocalDate.parse(dateParam, DateTimeFormatter.ofPattern("EEE MMM d yyyy"))
